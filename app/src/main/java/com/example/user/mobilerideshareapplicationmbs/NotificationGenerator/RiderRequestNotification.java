...
import com.example.user.mobilerideshareapplicationmbs.DriverDashboard;
import com.example.user.mobilerideshareapplicationmbs.DriverMapFragment;
import com.example.user.mobilerideshareapplicationmbs.R;

public class RiderRequestNotification {
    ...
    public static void openActivityNotification(Context context){
        ...
        Intent notifyIntent = new Intent(context, DriverDashboard.class);
        ...
        nc.setContentTitle("Rider Make Rideshare Request");
